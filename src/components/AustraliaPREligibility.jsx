      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            ...
            toast.success('Payment successful! Our team will connect within 24 hours.');
          } catch (error) {
    ...
    <div className="pr-page">
      ...
      <section className="pr-section">
        <div className="pr-container">
          {paymentSuccess ? (
            <div className="pr-card" style={{ textAlign: 'center', padding: '40px 32px' }}>
              <div
                style={{
                  width: 64,
                  height: 64,
              ...
              <h3 className="pr-card-title" style={{ fontSize: 22 }}>Payment Successful</h3>
              <p style={{ color: '#64748b', lineHeight: 1.7, maxWidth: 480, margin: '0 auto 20px' }}>
                Thank you, <strong>{name}</strong>. Your Rs.{ELIGIBILITY_SESSION_PRICE} session payment is confirmed.
                Our team will connect with you within 24 hours.
              </p>
              <Link to="/" className="pr-submit-btn" style={{ display: 'inline-block', textDecoration: 'none', maxWidth: 280 }}>
                Back to Home
              </Link>
            </div>
          ) : (
